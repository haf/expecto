...
they are using `Expecto.BenchmarkDotNet` for performance tests. You have to remember that the full name of test(s) should be unique across your test project.
